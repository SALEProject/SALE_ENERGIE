...
module.exports.routes = {
  ...
  '/admin/entrypoints/add': {
	controller: "AdminController",
	action: 'point_add'
  },
  '/admin/entrypoints/edit/:id': {
	controller: "AdminController",
	action: 'point_edit'
  },
  '/admin/entrypoints/delete/:id': {
	controller: "AdminController",
	action: 'point_delete'
  },
  '/admin/whitelist/add': {
  ...
  '/admin/whitelist/edit/:id': {
	controller: "AdminController",
	action: 'whitelist_edit'
  },
  '/admin/whitelist/delete/:id': {
	controller: "AdminController",
	action: 'whitelist_delete'
  },
  '/account/whitelist-reasons': {
	controller: "AccountController",
	action: 'whitelistReasons'
  },
  '/admin/whitelist/approve/:id': {
	controller: "AdminController",
	action: 'whitelist_request_approve'
  },
  '/orders/cancel/:id': {
	controller: "OrdersController",
	action: 'cancel'
  },
  '/home/readnotification/:id': {
	controller: "HomeController",
